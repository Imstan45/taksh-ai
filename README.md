...
2. Copy `.env.example` to `.env` and set PostgreSQL, Auth.js, Resend, and Vercel Blob values.
3. Run `pnpm install`.
...
Module 2 provides personal and education details, skills and programming languages with proficiency levels, career targets, placement status, achievements, certificates, projects, completion scoring, and private PDF resume uploads through Vercel Blob.
