...
export default async function DepartmentsPage() {
  ...
  return <DashboardShell {...session.user}><div className="grid gap-6 lg:grid-cols-[340px_1fr]">
    <form action={saveDepartment} className="glass-card h-fit space-y-3"><h2 className="text-xl font-semibold">Create department</h2><input className="field" name="name" placeholder="Department name" required /><input className="field" name="code" placeholder="Code" required /><button className="btn-primary">Create</button></form>
